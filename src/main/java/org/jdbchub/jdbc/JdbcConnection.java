...
public class JdbcConnection implements Connection {
	...
	public Statement createStatement() throws SQLException {
		return new JdbcStatement(this, target.createStatement());
	}

	@Override
	public PreparedStatement prepareStatement(String sql) throws SQLException {
		return new JdbcPreparedStatement(this, target.prepareStatement(transformSql(sql)));
	}

	@Override
	public CallableStatement prepareCall(String sql) throws SQLException {
		return new JdbcCallableStatement(this, target.prepareCall(transformSql(sql)));
	}

	@Override
	public String nativeSQL(String sql) throws SQLException {
		return target.nativeSQL(transformSql(sql));
	}
	...
	public Statement createStatement(int resultSetType, int resultSetConcurrency) throws SQLException {
		return new JdbcStatement(this, target.createStatement(resultSetType, resultSetConcurrency));
	}

	@Override
	public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
		return new JdbcPreparedStatement(this, target.prepareStatement(transformSql(sql), resultSetType, resultSetConcurrency));
	}

	@Override
	public CallableStatement prepareCall(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
		return new JdbcCallableStatement(this, target.prepareCall(transformSql(sql), resultSetType, resultSetConcurrency));
	}
	...
	public Statement createStatement(int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
		return new JdbcStatement(this, target.createStatement(resultSetType, resultSetConcurrency, resultSetHoldability));
	}

	@Override
	public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
		return new JdbcPreparedStatement(this, target.prepareStatement(transformSql(sql), resultSetType, resultSetConcurrency, resultSetHoldability));
	}

	@Override
	public CallableStatement prepareCall(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
		return new JdbcCallableStatement(this, target.prepareCall(transformSql(sql), resultSetType, resultSetConcurrency, resultSetHoldability));
	}

	@Override
	public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
		return new JdbcPreparedStatement(this, target.prepareStatement(transformSql(sql), autoGeneratedKeys));
	}

	@Override
	public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
		return new JdbcPreparedStatement(this, target.prepareStatement(transformSql(sql), columnIndexes));
	}

	@Override
	public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
		return new JdbcPreparedStatement(this, target.prepareStatement(transformSql(sql), columnNames));
	}
